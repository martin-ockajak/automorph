...
private[automorph] object CirceOpenApi {
  ...
  implicit private val schemaEncoder: Encoder[Schema] = new Encoder[Schema] {
  ...
  implicit private val schemaDecoder: Decoder[Schema] = new Decoder[Schema] {
  ...
  lazy val openApiEncoder: Encoder[OpenApi] = {
  ...
  lazy val openApiDecoder: Decoder[OpenApi] = {
