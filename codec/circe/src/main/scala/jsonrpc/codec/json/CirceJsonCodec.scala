...
final case class CirceJsonCodec[Custom <: CirceCustom](
  ...
  protected implicit val messageEncoder: Encoder[Message[Json]] = deriveEncoder[Message[Json]]
  protected implicit val messageDecoder: Decoder[Message[Json]] = deriveDecoder[Message[Json]]
