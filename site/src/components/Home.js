...
const features = [
  ...
  },
  {
    ...
    description: (
        <>
          Customize data type serialization, remote API function names, RPC protocol errors and <a
  ...
  },
  {
    ...
    description: (
        <>
          Access transport protocol metadata (e.g. authentication token) using optional API abstractions.
        </>
    ),
  },
  {
