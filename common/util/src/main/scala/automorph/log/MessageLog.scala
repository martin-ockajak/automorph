...
private[automorph] final case class MessageLog(logger: Logger, defaultProtocol: String) {
  ...
  def failedSendRequest(error: Throwable, requestProperties: => Map[String, String], protocol: String = defaultProtocol): Unit =
  ...
  def failedReceiveRequest(error: Throwable, requestProperties: => Map[String, String], protocol: String = defaultProtocol): Unit =
    logger.error(s"Failed to receive $protocol request", error, requestProperties)

  def failedProcessRequest(error: Throwable, requestProperties: => Map[String, String], protocol: String = defaultProtocol): Unit =
  ...
  def failedSendResponse(error: Throwable, responseProperties: => Map[String, String], protocol: String = defaultProtocol): Unit =
  ...
  def failedReceiveResponse(error: Throwable, responseProperties: => Map[String, String], protocol: String = defaultProtocol): Unit =
