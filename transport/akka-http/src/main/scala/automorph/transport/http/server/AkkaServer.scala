...
//  private val actorSystem = createActorSystem()
...
//  }
//
//  private def createActorSystem(): ActorSystem[Message] = {
//    ActorSystem(AkkaHttpEndpoint(
//      handler, mapException
//    ), AkkaServer.getClass.getSimpleName)
//  }
//
...
//      Http(actorSystem).newServerAt("0.0.0.0", port).withSettings(serverSettings).bind(route),
//      Duration.Inf
//    )
