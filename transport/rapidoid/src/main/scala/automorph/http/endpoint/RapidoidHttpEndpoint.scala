 ...
 * @see [[https://rapidoid.org Library documentation]]
 * @see [[https://rapidoid.org/latest/api/org/rapidoid/ API]]
 * @constructor Creates a Rapidoid HTTP service with the specified RPC request handler.
