...
private[automorph] trait ClientMeta[Node, ExactCodec <: Codec[Node], Effect[_], Context] {
   ...
   * @return result value
   */
  def callByName[T1, T2, R](method: String, p1: (String , T1), p2: (String , T2))(implicit context: Context): Effect[R] =
    macro ClientMeta.callByNameMacro[Effect, Context, T1, T2, R]
   ...
   * @return nothing
   */
  def notifyByName[T1](method: String, p1: (String, T1))(implicit context: Context): Effect[Unit] =
   ...
   * @return nothing
   */
  def notifyByName[T1, T2](method: String, p1: (String, T1), p2: (String, T2))(implicit context: Context): Effect[Unit] =
    macro ClientMeta.notifyByNameMacro[Effect, Context, T1, T2]
   ...
   * @return nothing
   */
  def notifyByName[T1, T2, T3, T4, T5, T6](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3),
    ...
    macro ClientMeta.notifyByNameMacro[Effect, Context, T1, T2, T3, T4, T5, T6]
   ...
   * @return nothing
   */
  def notifyByName[T1, T2, T3, T4, T5, T6, T7](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3),
    ...
    macro ClientMeta.notifyByNameMacro[Effect, Context, T1, T2, T3, T4, T5, T6, T7]
...
object ClientMeta {
  ...
  def callByNameMacro[Effect[_], Context, T1: c.WeakTypeTag, T2: c.WeakTypeTag, R: c.WeakTypeTag](c: blackbox.Context)(
    method: c.Expr[String],
    p1: c.Expr[(String, T1)],
    p2: c.Expr[(String, T2)]
  )(context: c.Expr[Context])(implicit resultType: c.WeakTypeTag[Effect[R]]): c.Expr[Effect[R]] = {
  ...
  def callByNameMacro[
    ...
    c.Expr[Effect[R]](q"""
      ${c.prefix}.performCall($method, Right(Map(
        ...
        $p4._1 -> ${c.prefix}.codec.encode[${weakTypeOf[T4]}]($p4._2),
        $p5._1 -> ${c.prefix}.codec.encode[${weakTypeOf[T5]}]($p5._2),
        $p6._1 -> ${c.prefix}.codec.encode[${weakTypeOf[T6]}]($p6._2)
      )), Some($context), resultNode => ${c.prefix}.codec.decode[${weakTypeOf[R]}](resultNode))
    """)
  }
  ...
  def callByNameMacro[
    ...
    c.Expr[Effect[R]](q"""
      ${c.prefix}.performCall($method, Right(Map(
        ...
        $p5._1 -> ${c.prefix}.codec.encode[${weakTypeOf[T5]}]($p5._2),
        $p6._1 -> ${c.prefix}.codec.encode[${weakTypeOf[T6]}]($p6._2),
        $p7._1 -> ${c.prefix}.codec.encode[${weakTypeOf[T7]}]($p7._2)
      )), Some($context), resultNode => ${c.prefix}.codec.decode[${weakTypeOf[R]}](resultNode))
    """)
  }
  ...
  def notifyByNameMacro[Effect[_], Context, T1: c.WeakTypeTag](c: blackbox.Context)(
    method: c.Expr[String],
    p1: c.Expr[(String, T1)]
  )(context: c.Expr[Context])(implicit resultType: c.WeakTypeTag[Effect[Unit]]): c.Expr[Effect[Unit]] = {
    import c.universe.{weakTypeOf, Quasiquote}
  ...
  def notifyByNameMacro[Effect[_], Context, T1: c.WeakTypeTag, T2: c.WeakTypeTag](c: blackbox.Context)(
    method: c.Expr[String],
    p1: c.Expr[(String, T1)],
    p2: c.Expr[(String, T2)]
  )(context: c.Expr[Context])(implicit resultType: c.WeakTypeTag[Effect[Unit]]): c.Expr[Effect[Unit]] = {
  ...
  def notifyByNameMacro[Effect[_], Context, T1: c.WeakTypeTag, T2: c.WeakTypeTag, T3: c.WeakTypeTag](c: blackbox.Context)(
    method: c.Expr[String],
    p1: c.Expr[(String, T1)],
    p2: c.Expr[(String, T2)],
    p3: c.Expr[(String, T3)]
  ...
  def bindMacro[
    ...
    c.Expr[Api](q"""
      ...
      val methodBindings = automorph.client.ClientBindings.generate[$nodeType, $codecType, $effectType, $contextType, $apiType](codec)
