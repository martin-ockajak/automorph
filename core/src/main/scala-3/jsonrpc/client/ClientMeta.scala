...
private[jsonrpc] trait ClientMeta[Node, ExactCodec <: Codec[Node], Effect[_], Context]:
   ...
   * @return result value
   */
  inline def callByName[T1, T2, R](method: String, p1: (String, T1), p2: (String, T2))(using
    context: Context
  ): Effect[R] =
    val encodedArguments = Right(Map(
      p1._1 -> codec.encode(p1._2),
   ...
   * @return result value
   */
  inline def callByName[T1, T2, T3, R](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3)
   ...
   * @return result value
   */
  inline def callByName[T1, T2, T3, T4, R](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3),
   ...
   * @return result value
   */
  inline def callByName[T1, T2, T3, T4, T5, R](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3),
   ...
   * @return nothing
   */
  inline def notifyByName[T1, T2](method: String, p1: (String, T1), p2: (String, T2))(using
    context: Context
  ): Effect[Unit] =
    val encodedArguments = Right(Map(
      p1._1 -> codec.encode(p1._2),
   ...
   * @return nothing
   */
  inline def notifyByName[T1, T2, T3](method: String, p1: (String, T1), p2: (String, T2), p3: (String, T3))(using
    context: Context
  ): Effect[Unit] =
    val encodedArguments = Right(Map(
      p1._1 -> codec.encode(p1._2),
   ...
   * @return nothing
   */
  inline def notifyByName[T1, T2, T3, T4](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3),
   ...
   * @return nothing
   */
  inline def notifyByName[T1, T2, T3, T4, T5](
    method: String,
    p1: (String, T1),
    p2: (String, T2),
    p3: (String, T3),
